...
- "deleteOne() deletes a single document that matches the filter. If multiple documents match, MongoDB deletes one of them. If you need a specific document deleted, use a unique filter such as _id."
